-- Main migration v17 -> v18 (018-managed-exports), T18c.
-- Managed exports use their own registry/outbox; the extract/embed job queue
-- is unchanged. No backfill is needed before the first managed export.
...
CREATE TABLE IF NOT EXISTS managed_export (
  ...
  target_kind TEXT NOT NULL CHECK (target_kind IN ('claude_skill', 'codex_instruction')),
