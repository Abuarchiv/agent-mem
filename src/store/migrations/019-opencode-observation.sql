-- Main migration v18 -> v19 (019-opencode-observation), T05g.
-- The operation is additive: existing source rows and their fingerprints are
-- untouched. Native identity state contains no copied payload or digest.
